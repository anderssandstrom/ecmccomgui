...
if len(sys.argv)!=9:
  print("python ecmcTestStepScan.py <motorPvNamepv> <testnumberpv> <startpos> <stoppos> <step> <velo> <testbasenum> <countUp>")
  print("python ecmcTestStepScan.py IOC:Axis1 IOC:TestNumber 60 5 5 0.75 7100 1")
  sys.exit()
