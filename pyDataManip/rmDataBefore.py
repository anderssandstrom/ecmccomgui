...
def printOutHelp():    
  print "python rmDataBefore.py [<filename>] <time>"
  print "Remove data before a certain time."
  print "example: python rmDataBefore.py xx.txt '2019-05-16 08:51:25.869000' "
  print "example stdin: cat data.log | grep -E 'ActPos' | python rmDataBefore.py '2019-05-16 08:51:25.869000'" 
